...
## How to Use
1. Browse `sources/github/anthropic-cybersecurity-skills/skills/` for available skills
2. Each skill directory contains a `SKILL.md` with complete workflow instructions
3. Use `sources/github/anthropic-cybersecurity-skills/index.json` for programmatic discovery
...
## Full Source
Browse all 754 skills at: `sources/github/anthropic-cybersecurity-skills/skills/`
