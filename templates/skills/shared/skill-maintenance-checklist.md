...
Before modifying any skill wrapper, check the local upstream repository checkout under `sources/github/`. Compare the current installed version's features with:
...
|---|---|---|
| **CocoIndex** | [sources/github/cocoindex](file:///c:/.USER FOLDER/Projects/Project-skill-setup/sources/github/cocoindex) | `cocoindex-rag-pipeline.md` |
| **Mem0** | [sources/github/mem0](file:///c:/.USER FOLDER/Projects/Project-skill-setup/sources/github/mem0) | `mem0-memory.md` |
| **Graphiti** | [sources/github/graphiti](file:///c:/.USER FOLDER/Projects/Project-skill-setup/sources/github/graphiti) | `graphiti-knowledge-graphs.md` |
